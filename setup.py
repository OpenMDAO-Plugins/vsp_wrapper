...
kwargs = {'author': 'Scott E. Townsend',
 ...
 'package_data': {'vsp_wrapper': ['sphinx_build/html/index.html',
                                  ...
                                  'sphinx_build/html/_modules/vsp_wrapper/parageom.html',
                                  ...
                                  'sphinx_build/html/_modules/vsp_wrapper/test/test_wrapper.html',
                                  'sphinx_build/html/_modules/vsp_wrapper/test/test_parageom.html',
                                  'test/test.tee',
                                  'test/hwb.xml.new_CompGeom.txt',
                                  'test/Schweizer2_32.xml',
                                  'test/test_parageom.py',
                                  'test/__init__.py',
                                  'test/Cessna182.xml',
                                  'test/eagle_eye.xml',
                                  'test/VspAircraft.poly',
                                  'test/VspAircraft.tri',
                                  'test/Cessna182.xml.new_CompGeom.csv',
                                  'test/GE90.xml.new_CompGeom.csv',
                                  'test/Cessna182.xml.new_CompGeom.txt',
                                  'test/777.xml',
                                  'test/VspAircraft_NASCART.key',
                                  'test/Cessna182.vsp',
                                  'test/hwb.xml',
                                  'test/hwb.xml.newcfdmesh.bez',
                                  'test/eagle_eye.xml.new_CompGeom.csv',
                                  'test/VspAircraft.obj',
                                  'test/Schweizer2_32.xml.new_CompGeom.csv',
                                  'test/openmdao_log.txt',
                                  'test/GE90.xml.new_CompGeom.txt',
                                  'test/VspAircraft.msh',
                                  'test/GE90.xml',
                                  'test/VspAircraft_NASCART.dat',
                                  'test/m6_singleside.xml',
                                  'test/hwb.xml.new_CompGeom.csv',
                                  'test/eagle_eye.xml.new_CompGeom.txt',
                                  'test/test_wrapper.py',
                                  'test/Schweizer2_32.xml.new_CompGeom.txt',
                                  'test/VspAircraft.srf']},
 'package_dir': {'': 'src'},
 'packages': ['vsp_wrapper', 'vsp_wrapper.test'],
